...
export default function LandingHeader() { 
  ...
  return ( 
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/95 
backdrop-blur"> 
          ...
          <nav className="flex flex-col space-y-1 p-4"> 
            {navLinks.map((link) => ( 
              <a 
                ...
                className="rounded-md px-3 py-2 text-base font-medium text-neutral-800 
hover:bg-neutral-100 hover:text-primary-600" 
            ...
            <div className="flex flex-col gap-2 pt-4"> 
              <a 
                href="#login" 
                onClick={() => setMobileOpen(false)} 
                className="rounded-md px-3 py-2 text-center text-base font-medium 
text-neutral-800 hover:bg-neutral-100" 
              ...
              <a 
                href="#signup" 
                onClick={() => setMobileOpen(false)} 
                className="rounded-md bg-primary-600 px-3 py-2 text-center text-base 
font-semibold text-white hover:bg-primary-700" 
              > 
                Sign up 
              </a> 
            </div> 
